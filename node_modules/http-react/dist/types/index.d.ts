...
export type FetchContextType = {
    ...
    onFetchStart?(req: Request, config: FetchConfigType, ctx: FetchContextType): void;
    onFetchEnd?(res: Response, config: FetchConfigType, ctx: FetchContextType): void;
